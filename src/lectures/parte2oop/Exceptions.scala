...
object Exceptions extends App {
  ...
  val x: String = null
  // println(x.length)
  // this ^^ will crash with null ponter exception
  ...
  // Exception and Error are the major Throwable subtypes
      // Ex - something went wrong with the program
      // Er - something went wrong with the system e.g. stackoverflow
  ...
  class MyException extends Exception // they have parameters, fields and methods
